package com.template.Controller.PartyB
 ...
 */
@RestController("PartyBHouseController")
@RequestMapping("/partyB/house") // The paths for HTTP requests are relative to this base path.
class PartyBHouseController(@Qualifier("partyBConnection") rpc: NodeRPCConnection) {
