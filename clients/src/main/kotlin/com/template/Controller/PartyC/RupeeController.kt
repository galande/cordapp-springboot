 ...
 */
@RestController("PartyBRupeeController")
@RequestMapping("/partyB/rupee") // The paths for HTTP requests are relative to this base path.
class PartyBRupeeController(@Qualifier("partyBConnection") rpc: NodeRPCConnection) {
