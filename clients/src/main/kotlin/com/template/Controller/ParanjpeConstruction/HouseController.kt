 ...
 */
@RestController("ParanjpeConHouseController")
@RequestMapping("/paranjpeCon/house") // The paths for HTTP requests are relative to this base path.
class ParanjpeConHouseController(@Qualifier("paranjpeConstructionConnection") rpc: NodeRPCConnection) {
